...
=head1 SYNOPSIS
 ...
 Enables the description of multiple values for a parameter via an array (reference).
 my $client = Net::HTTP::Spore->new_from_spec('some_spec.json');
 $client->enable('Params::MultiValue');
